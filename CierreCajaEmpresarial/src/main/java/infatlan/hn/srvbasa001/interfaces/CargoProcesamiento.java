 ...
 *         &lt;element name="metodoPagoProcesamiento" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="indicadorPartidaDebito" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CargoProcesamiento", propOrder = {
    ...
    "metodoPagoProcesamiento",
    "indicadorPartidaDebito"
})
public class CargoProcesamiento {
    ...
    @XmlElement(defaultValue = "")
    protected String metodoPagoProcesamiento;
    @XmlElement(defaultValue = "")
    protected String indicadorPartidaDebito;
    ...
    /**
     * Obtiene el valor de la propiedad metodoPagoProcesamiento.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getMetodoPagoProcesamiento() {
        return metodoPagoProcesamiento;
    }

    /**
     * Define el valor de la propiedad metodoPagoProcesamiento.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMetodoPagoProcesamiento(String value) {
        this.metodoPagoProcesamiento = value;
    }

    /**
     * Obtiene el valor de la propiedad indicadorPartidaDebito.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getIndicadorPartidaDebito() {
        return indicadorPartidaDebito;
    }

    /**
     * Define el valor de la propiedad indicadorPartidaDebito.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setIndicadorPartidaDebito(String value) {
        this.indicadorPartidaDebito = value;
    }
