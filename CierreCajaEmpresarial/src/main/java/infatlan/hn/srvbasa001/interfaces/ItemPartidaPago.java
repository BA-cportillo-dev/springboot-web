 ...
 *         &lt;element name="devolucionCheque" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 ...
 *         &lt;element name="indicadorExencionCargo" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 ...
 *         &lt;element name="monedaParaCuenta" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="montoParaCuenta" type="{http://www.w3.org/2001/XMLSchema}double" minOccurs="0"/>
...
public class ItemPartidaPago {
    ...
    protected boolean devolucionCheque;
    @XmlElement(defaultValue = "")
    ...
    protected boolean indicadorExencionCargo;
    @XmlElement(defaultValue = "")
    protected String monedaTransaccion;
    @XmlElement(defaultValue = "0.00")
    protected Double montoTransaccion;
    protected String monedaParaCuenta;
    protected Double montoParaCuenta;
    @XmlElement(defaultValue = "")
    ...
    /**
     * Obtiene el valor de la propiedad devolucionCheque.
     * 
     */
    public boolean isDevolucionCheque() {
        return devolucionCheque;
    }

    /**
     * Define el valor de la propiedad devolucionCheque.
     * 
     */
    public void setDevolucionCheque(boolean value) {
        this.devolucionCheque = value;
    }
    ...
    /**
     * Obtiene el valor de la propiedad indicadorExencionCargo.
     * 
     */
    public boolean isIndicadorExencionCargo() {
        return indicadorExencionCargo;
    }

    /**
     * Define el valor de la propiedad indicadorExencionCargo.
     * 
     */
    public void setIndicadorExencionCargo(boolean value) {
        this.indicadorExencionCargo = value;
    }
    ...
    /**
     * Obtiene el valor de la propiedad monedaParaCuenta.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getMonedaParaCuenta() {
        return monedaParaCuenta;
    }

    /**
     * Define el valor de la propiedad monedaParaCuenta.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMonedaParaCuenta(String value) {
        this.monedaParaCuenta = value;
    }

    /**
     * Obtiene el valor de la propiedad montoParaCuenta.
     * 
     * @return
     *     possible object is
     *     {@link Double }
     *     
     */
    public Double getMontoParaCuenta() {
        return montoParaCuenta;
    }

    /**
     * Define el valor de la propiedad montoParaCuenta.
     * 
     * @param value
     *     allowed object is
     *     {@link Double }
     *     
     */
    public void setMontoParaCuenta(Double value) {
        this.montoParaCuenta = value;
    }
